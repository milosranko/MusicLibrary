...
namespace MusicLibrary.Indexer.Models
{
    ...
    {
        public string FileId { get; set; } //Unique file location eg. disc:\root\sub\sub\sub\File.ext
        ...
        public string[] Tags { get; set; } //Meta tags: Artist/Album/Year/Genre/Title/TrackNo
    }
}
